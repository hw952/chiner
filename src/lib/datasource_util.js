...
export const getFullColumns = () => {
  return [
    ...
    {code: 'dataBaseField', value: FormatMessage.string({id: 'tableHeaders.dataBaseField'}), newCode: 'dataBaseField', com: 'Checkbox', relationNoShow: true},
    {code: 'dtoAdd', value: FormatMessage.string({id: 'tableHeaders.dtoAdd'}), newCode: 'dtoAdd', com: 'Checkbox', relationNoShow: true},
    {code: 'dtoUpdate', value: FormatMessage.string({id: 'tableHeaders.dtoUpdate'}), newCode: 'dtoUpdate', com: 'Checkbox', relationNoShow: true},
    {code: 'dtoList', value: FormatMessage.string({id: 'tableHeaders.dtoList'}), newCode: 'dtoList', com: 'Checkbox', relationNoShow: true},
    {code: 'dtoSearch', value: FormatMessage.string({id: 'tableHeaders.dtoSearch'}), newCode: 'dtoSearch', com: 'Checkbox', relationNoShow: true},
    {code: 'parentId', value: FormatMessage.string({id: 'tableHeaders.parentId'}), newCode: 'parentId', com: 'Checkbox', relationNoShow: true},
